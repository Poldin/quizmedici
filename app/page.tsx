...
export default function QuizPage() {
  ...
  const handleAnswer = (option: QuizOption) => {
    ...
    setTimeout(() => {
      // Prepariamo il contenuto del feedback
  ...
  return (
    <main className="flex flex-col min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 max-w-md mx-auto border-x border-zinc-200 dark:border-zinc-800 font-sans">

      {/* Header */}
      <header className="px-4 py-1 border-b border-zinc-200 dark:border-zinc-800 sticky top-0 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md z-10 flex justify-between items-center">
        <h1 className="font-black text-lg tracking-tighter uppercase italic">QuizMedici</h1>
        <div className="flex items-center gap-2">
          <span className="text-[10px] uppercase font-bold text-zinc-400">Progresso</span>
          <div className="text-xs font-mono bg-zinc-100 dark:bg-zinc-900 px-2 py-1 rounded border border-zinc-200 dark:border-zinc-800">
        ...
        {isFinished && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center py-12 px-4 space-y-6">
            ...
            <div className="p-4 bg-zinc-100 dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800">
              ...
              <p className="text-sm font-medium italic italic">"condividi questo quiz con i tuoi amici per metterli alla prova!"</p>
            </div>
            <button
